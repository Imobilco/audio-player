...
//		this.jQuery = "jQuery(\"#" + scope.id + "\").jPlayer";
		this.jQuery = "imob_player.getMedia().flashCall";
	...
	function init():Void {
		...
		ExternalInterface.addCallback("fl_get_position", this, this.get_position);
		ExternalInterface.addCallback("fl_get_duration", this, this.get_duration);
		ExternalInterface.addCallback("fl_is_playing", this, this.is_playing);
...
/*			ExternalInterface.call(this.jQuery, "jPlayerOnProgressChange", 0, 0, 0, 0, 0);*/
	...
	function auto_play_mp3():Void {
		...
		ExternalInterface.call(this.jQuery, "onPlaybackStart");
...
/*		ExternalInterface.call(this.jQuery, "jPlayerOnProgressChange", loadPercent, playedPercentRelative, playedPercentAbsolute, playedTime, totalTime);*/
		ExternalInterface.call(this.jQuery, "onLoadProgress", this.mySound.getBytesLoaded(), this.mySound.getBytesTotal());
...
/*		ExternalInterface.call(this.jQuery, "jPlayerVolume", this.vol);*/
	...
	function get_position():Number {
		return this.mySound.getPosition();
	}
